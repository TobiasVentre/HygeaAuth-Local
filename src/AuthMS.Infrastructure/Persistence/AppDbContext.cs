    ...
    public class AppDbContext : DbContext
    {
        ...
        {            
            ...
            modelBuilder.Entity<Notification>(b =>
            {
                ...
                b.Property(x => x.Type).HasConversion<string>().HasMaxLength(100).IsUnicode(false);
                b.Property(x => x.Status).HasConversion<string>().HasMaxLength(100).IsUnicode(false);
                b.Property(x => x.Payload).HasColumnType("longtext");
